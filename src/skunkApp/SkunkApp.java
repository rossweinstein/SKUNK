...
import skunkApp.game.SkunkMainMenu;
 ...
 * aSkunk and losing his score.
 * 
 * PENALTIES:
 * 
 * A skunk in any series voids the score for that series only and draws a
 * penalty of 1 chip placed in the "kitty," and loss of dice.
 * 
 * A skunk and a deuce voids the score for that series only and draws a penalty
 * of 2 chips placed in the "kitty," and loss of dice.
 * 
 * TWO skunks void the ENTIRE accumulated score and draws a penalty of 4 chips
 * placed in the "kitty," and loss of dice. Player must again start to score
 * from scratch.
 * 
 * Any number can play. The suggested number of chips to start is 50. There are
 * sufficient chips in the box to allow 8 players to start with 50 chips by
 * placing a par value of "one" on white chips, 5 for 1 on red chips and 10 for
 * 1 on the blue chips.
 * 
...
public class SkunkApp {
	...
	public static void main(String[] args) {
		SkunkMainMenu skunkGame = new SkunkMainMenu();
		skunkGame.playGame();
	}
}
